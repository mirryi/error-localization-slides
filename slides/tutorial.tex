...
\begin{frame}[fragile]
  ...
  \note[item]{Secondly, since marked terms are used to provision downstream services, it makes sense
    to define a typing semantics for them, which we denote with the M under the turnstile}

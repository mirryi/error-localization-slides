...
let rec syn ctx e =
  ...
  \note[item]{An implementation of type synthesis might look something like this OCaml code}
...
\begin{frame}{\ldots\ and the rest}
  ...
  \note[item]{and a conditional where the branches synthesize inconsistent types, as in the example
    at the very beginning of this talk}
  \note[item]{The first two are similar in flavor to the inconsistent types mark we just saw, but
    we've given them separately because we have more information in these cases}
